...
namespace CppCoverage
{
			...
			const std::vector<std::unique_ptr<IOptionParser>>& optionParsers)
		{
			...
			options.add_options()
              ...
              (ProgramOptions::UnifiedDiffOption.c_str(),
				...
				(ProgramOptions::EnableDebugCallbackOption.c_str(), "Enable debug callback function to be executed on OnOutputDebugString().");
	...
	const std::string ProgramOptions::EnableDebugCallbackOption = "enable_debug_callback";
